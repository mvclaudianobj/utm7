...
$home_net_list = suricata_build_list_acp($suricatacfg, $suricatacfg['homelistname']);
$home_net = implode(",", $home_net_list);
$home_net = trim($home_net);
$external_net = "";
if (!empty($suricatacfg['externallistname']) && $suricatacfg['externallistname'] != 'default') {
	$external_net_list = suricata_build_list_acp($suricatacfg, $suricatacfg['externallistname'], false, true);
...
if ($suricatacfg['ips_mode'] == 'ips_mode_legacy' && $suricatacfg['blockoffenders'] == 'on' && $suricatacfg['passlistname'] != 'none') {
	$plist = suricata_build_list_acp($suricatacfg, $suricatacfg['passlistname'], true);
...
$suppress = suricata_find_list_acp($suricatacfg['suppresslistname'], 'suppress');
if (!empty($suppress)) {
...
suricata_prepare_rule_files_acp($suricatacfg, $suricatacfgdir);
